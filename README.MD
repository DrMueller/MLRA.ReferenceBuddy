...
- Direct NuGet dependencies use major-bounded version ranges (for example `[x.y.z, nextMajor.0.0)`) to keep compatibility broad while avoiding unintended major-version upgrades.
